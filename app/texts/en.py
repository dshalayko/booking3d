...
UI.update(
    {
        ...
        "unit_hours": UNIT_HOURS,
        "usage_auto_reason_policy": "Global settings changed",
        "usage_auto_reason_settings": "Personal settings changed",
        "usage_auto_reason_bonus": "Extra hours granted",
        "usage_auto_reason_reset": "Allowance reset",
        "usage_search_label": "Find user",
        "usage_search_placeholder": "Type a name",
        "usage_search_empty": "No users found.",

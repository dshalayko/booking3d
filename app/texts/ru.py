...
BOT_WELCOME = (
    ...
    "Следом отправлю PIN отдельным сообщением и закреплю его наверху чата. "
...
BOT_PIN_CHANGED = (
    ...
    "Новый отправляю следующим сообщением и закрепляю вместо прежнего."
)

BOT_PIN_MESSAGE = "🔑 Ваш PIN: <b>{pin}</b>"
...
UI = {
    'admin_nav_broadcasts': 'Рассылка',
    'broadcast_send_all_link': 'Отправить сообщение всем',
    'broadcast_send': 'Отправить сообщение',
    'broadcast_recipients': 'Получатели',
    'broadcast_selected': 'Выбранным пользователям',
    'broadcast_all': 'Всем пользователям бота',
    'broadcast_selection_hint': (
        'Отметьте одного или нескольких пользователей. В режиме «Всем» сообщение получат '
    ...
    'broadcast_not_configured': 'Бот не подключён. Отправка сообщений недоступна.',
    'broadcast_invalid_text': 'Введите сообщение длиной от 1 до 4096 символов.',
    'broadcast_invalid_audience': 'Выберите режим отправки.',
    'broadcast_choose_users': 'Выберите хотя бы одного получателя.',
    'broadcast_missing_users': 'Некоторые получатели больше недоступны. Обновите список.',
    'broadcast_no_users': 'Нет пользователей для отправки.',
...
USAGE_DISABLED = "Лимиты использования выключены."
USAGE_UNLIMITED = "Использование оборудования без лимита."
USAGE_COOLDOWN = (
    "Лимит использования исчерпан. Снова занимать оборудование и бронировать "
    "можно {until} ({zone})."
)
USAGE_BALANCE = (
...
UI.update(
    {
        ...
        "unit_hours": UNIT_HOURS,
        "usage_auto_reason_policy": "Изменены общие настройки",
        "usage_auto_reason_settings": "Изменены персональные настройки",
        "usage_auto_reason_bonus": "Добавлены часы",
        "usage_auto_reason_reset": "Лимит сброшен",
        "usage_search_label": "Найти пользователя",
        "usage_search_placeholder": "Введите имя",
        "usage_search_empty": "Пользователи не найдены.",
        ...
        "usage_hint": (
            ...
            "после расходования всех часов. Старые работы и брони до включения "
            "сохраняются без списания. Изменение длительности cooldown действует на "
            "новые периоды ожидания."
        ),
        "usage_save": "Сохранить",
        "usage_reason": "Причина изменения",
        ...
        "usage_reset_hint": (
            ...
            "время текущих работ продолжают резервировать часы."
        ),
        "usage_history": "История изменений",
        "usage_person": "Пользователь",
        "usage_all": "Все пользователи",
        "usage_off_hint": (
            "При повторном включении начинается новый учёт для всех. Персональные лимиты "
            "сохраняются; старые работы и брони освобождаются от нового учёта."
        ),
    }
)
FLASH_ADMIN["usage_saved"] = "Лимиты обновлены."

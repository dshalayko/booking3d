...
UI = {
    ...
    "schedule_work_hours": "Мастерская открыта {hours}",
    ...
    "admin_hours_block": "Когда мастерская открыта",
    "admin_hours_opens": "Открытие",
    "admin_hours_closes": "Закрытие",
    "admin_hours_submit": "Сохранить",
    "admin_hours_current": "Сейчас: {hours}",
    "admin_hours_hint": (
        "Начать бронь можно только в эти часы — расписание показывает их и "
        "ничего больше. Конец брони часы не ограничивают: поставленная в 19:00 "
        "печать честно идёт всю ночь, забрать деталь человек придёт с открытия. "
        "Круглосуточная мастерская — это 00:00 и 00:00. "
        "Уже сделанные брони новые часы не трогают: если сдвинули расписание, "
        "проверьте список брон на вкладке «Сводка»."
    ),
}

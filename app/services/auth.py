...
Бронировать можно только с планшета у принтеров, по PIN. Планшет один раз
...
доска открыта всем, — но занимать принтеры и вставать в очередь только у
самих принтеров.
...
ждёт, пока чужая сессия истечёт, либо занимает принтер от чужого имени.
